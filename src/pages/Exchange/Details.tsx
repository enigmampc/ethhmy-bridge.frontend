...
//             <Box direction="row" justify="end" margin={{ top: '-10px' }} onClick={() => setShowDetails(true)}>
//               <Icon size="14px" glyph="ArrowDown" style={{ marginRight: 10 }} />
...
//
//           {isShowDetail && isETH ? (
//             <Box direction="row" justify="end" onClick={() => setShowDetails(false)}>
...
// });
//
// export const TokenDetails = observer<{ showTotal?: boolean; children?: any }>(({ showTotal, children }) => {
